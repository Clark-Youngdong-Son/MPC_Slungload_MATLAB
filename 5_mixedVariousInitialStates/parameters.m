...
for i=1:initialNumber
   x_initial(4:6,i) = randn(3,1)*0.1;
   x_initial(7:8,i) = randn(2,1)*0.1;
   x_initial(9,i) = 1 + randn*0.1;
   x_initial(7:9,i) = x_initial(7:9,i)/norm(x_initial(7:9,i));
   if(x_initial(9,i)>0)
       x_initial(7:9,i) = -x_initial(7:9,i);
   end
   x_initial(13:15,i) = randn(3,1)*0.5;
   x_initial(13:15,i) = randn(3,1)*0.5;
end
x_final(1,1) = 3;
x_final(9,1) = -1;
...
cost_param.L = diag([100 100 300 10 10 10 10 10 10 6 6 18 1 1 1 1 1 0]);
% cost_param.Q = diag([10 10 30 10 10 10 100 100 100 6 6 18 10 10 10 1 1 0]);
